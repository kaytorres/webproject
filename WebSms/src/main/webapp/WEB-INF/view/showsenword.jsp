...
<script type="text/javascript" src="<c:url value="/resource/js/senword.js"/>"></script>

<title>神计短信系统·敏感词维护</title>
</head>
<body >
<input type="hidden" id="appSessionID" value="${appSessionID }"/>
<input type="hidden" id="appID" value="${appID }"/>
<input type="hidden" id="oldsenwordid" name="oldsenwordid"/>
...
<td width="20px"></td>
<td width="40px">ID</td>
<td width="100px"><input type="text" id="senwordid" name="senwordid" readonly style="width:80px" onkeydown="keyinput()" /></td>

<td width="40px">敏感词</td>
<td width="100px"><input type="text" id="senwordcontent" name="senwordcontent" style="width:80px" onkeydown="keyinput()" /></td>
<td width="300px" align="center">
<form enctype="multipart/form-data"  name="filepost" id="filepost" method ="post" action="/import.do" >
<!-- <input type="file"  value="上传文件" id="file"  onchange="submitfile()" style="width:65px" /> -->
<table>
<tr>
<td width="80px">
<input type="file" name="file" id="file" onchange="submitfile()" style="display:none;" />
<input type="button"  readonly  value="浏览" onclick="file.click();filepath.value=file.value;" style="width:50px;height:25px;color:#FCFCFC;background:url(/resource/image/button.png);border-style:none;" /> 
 </td>
 <td  width="120px" id="showupload"> </td>
 <td  width="100px">
 <input type="submit"  id="submit" disabled value="导入" style="width:50px;height:25px;color:#FCFCFC;background:url(/resource/image/button.png);border-style:none;" />
 </td>
</tr>
</table>
...
<td align="center" width="60px">
		<input type="button" value="修&nbsp;改" onclick="senwordmodify()" style="width:50px;height:25px;color:#FCFCFC;background:url(/resource/image/button.png);border-style:none;" ></input>
</td>
<td align="center" width="40px">
</td>	
<td align="center" width="60px">
		<input type="button" value="新&nbsp;增" onclick="senwordadd()" style="width:50px;height:25px;color:#FCFCFC;background:url(/resource/image/button.png);border-style:none;" ></input>
</td>
					...
					<tr  valign="top" style="height:50px">
						<td id="print_area" >
							<table id="recordTable"
								...
								<thead>
									<tr>
										<th width="100px" class="dxgvHeader_Aqua">
											ID
										</th>
										<th width="500px" class="dxgvHeader_Aqua">
											内容
										</th>
										<th width="260px" class="dxgvHeader_Aqua">
											操作
										</th>
									</tr>
								</thead>
